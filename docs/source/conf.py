# -*- coding: utf-8 -*-
#
# hep_rfm documentation build configuration file, created by
...
# hep_rfm.core.decorate (which calls functools.wrap), only "*args, **kwargs"
...
def no_op_wraps(func):
    ...
    '''
    if func.__module__ is None or 'hep_rfm' not in func.__module__:
...
version = hep_rfm.version.__version__
# The full version, including alpha/beta/rc tags.
release = hep_rfm.version.__version__
...
latex_documents = [
    (master_doc, 'hep_rfm.tex', u'hep_rfm Documentation',
...
man_pages = [
    (master_doc, 'hep_rfm', u'hep_rfm Documentation',
     [author], 1)
]
