#!/usr/bin/env python
'''
Setup script for the xrootd_fmgt package
'''
...
version_file = open('xrootd_fmgt/version.py', 'wt')
version_file.write("""\
'''
Auto-generated module holding the version of the xrootd_fmgt package
'''
